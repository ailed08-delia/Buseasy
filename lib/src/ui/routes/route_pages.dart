import 'package:auth_example/src/ui/pages/empresa/empresas_binding.dart';
import 'package:auth_example/src/ui/pages/empresa/empresas_page.dart';
...
class RoutePages {
  ...
  static List<GetPage<dynamic>> get all {
    return [
      ...
      GetPage(
        name: RouteNames.empresa,
        page: () => const EmpresaPage(),
        binding: const EmpresaBinding(),
      ),
    ];
  }
}
